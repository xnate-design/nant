import { require_react } from './chunk-BI65ZRTA.js';
import { __toESM } from './chunk-UXIASGQL.js';

// ../../node_modules/.pnpm/prism-react-renderer@2.0.6_react@18.2.0/node_modules/prism-react-renderer/dist/index.mjs
...
!(function (e) {
  var n = { pattern: /\\[\\(){}[\]^$+*?|.]/, alias: 'escape' },
    ...
    a = '(?:[^\\\\-]|' + t.source + ')',
    a = RegExp(a + '-' + a),
    r2 = { pattern: /(<|')[^<>']+(?=[>']$)/, lookbehind: true, alias: 'variable' };
  e.languages.regex = {
    'char-class': {
      pattern: /((?:^|[^\\])(?:\\\\)*)\[(?:[^\\\]]|\\[\s\S])*\]/,
      lookbehind: true,
      inside: {
        ...
        range: { pattern: a, inside: { escape: t, 'range-punctuation': { pattern: /-/, alias: 'operator' } } },
        'special-escape': n,
    ...
    backreference: [
      ...
      { pattern: /\\k<[^<>']+>/, alias: 'keyword', inside: { 'group-name': r2 } },
    ],
  ...
  (function (e) {
    ...
    (e.languages.coffeescript = e.languages.extend('javascript', {
      ...
      string: [
        ...
        { pattern: /"(?:\\[\s\S]|[^\\"])*"/, greedy: true, inside: { interpolation: t } },
      ],
      keyword:
      ...
      e.languages.insertBefore('coffeescript', 'string', {
        ...
        'multiline-string': [
          ...
          { pattern: /"""[\s\S]*?"""/, greedy: true, alias: 'string', inside: { interpolation: t } },
        ],
      }),
        ...
        (e2 = 'string' == typeof e2 ? [e2] : e2).forEach(function (e3) {
          ...
          if ((a = l.languages[e3])) {
            ...
            if (
              ((r2 = r2
                ? r2
                : (a = l.languages.insertBefore(e3, 'comment', {
                    'doc-comment': {
                      pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/,
                      lookbehind: true,
                      alias: 'comment',
                    },
                  }))[t]) instanceof RegExp && (r2 = a[t] = { pattern: r2 }),
              Array.isArray(r2))
            )
  ...
  (function (e) {
    var n = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,
      n =
          ...
          inside: (n = {
            ...
            attribute: {
              ...
              inside: {
                ...
                'attr-value': [n, { pattern: /(=\s*)(?:(?!\s)[-\w\xA0-\uFFFF])+(?=\s*$)/, lookbehind: true }],
                operator: /[|~*^$]?=/,
              },
            },
            'n-th': [
        ...
        { pattern: /(\b\d+)(?:%|[a-z]+(?![\w-]))/, lookbehind: true }),
      t = { pattern: /(^|[^\w.-])-?(?:\d+(?:\.\d+)?|\.\d+)/, lookbehind: true };
    e.languages.insertBefore('css', 'function', {
      ...
      color: [
        ...
        },
        {
          ...
          inside: { unit: n, number: t, function: /[\w-]+(?=\()/, punctuation: /[(),]/ },
        },
      ],
      entity: /\\[\da-f]{1,8}/i,
      unit: n,
  ...
  (function (e) {
    ...
    (e.languages.yaml = {
      ...
      boolean: { pattern: i(/false|true/.source, 'i'), lookbehind: true, alias: 'important' },
      null: { pattern: i(/null|~/.source, 'i'), lookbehind: true, alias: 'important' },
      string: { pattern: i(s), lookbehind: true, greedy: true },
      number: {
  ...
  Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
    value: function (e, n) {
      var t = {},
        ...
        n = ((t['language-' + n] = { pattern: /[\s\S]+/, inside: Prism.languages[n] }), {});
      (n[e] = {
        pattern: RegExp(
  ...
  (function (o) {
    ...
    function e(e2) {
      return (
        (e2 = e2.replace(/<inner>/g, function () {
          return n;
        })),
        RegExp(/((?:^|[^\\])(?:\\{2})*)/.source + '(?:' + e2 + ')')
      );
      ...
      l =
        ...
        o.languages.insertBefore('markdown', 'prolog', {
          'front-matter-block': {
            ...
            inside: {
              punctuation: /^---|---$/,
              'front-matter': { pattern: /\S+(?:\s+\S+)*/, alias: ['yaml', 'language-yaml'], inside: o.languages.yaml },
            },
          },
          ...
          table: {
            ...
            inside: {
              'table-data-rows': {
                ...
                lookbehind: true,
                inside: { 'table-data': { pattern: RegExp(t), inside: o.languages.markdown }, punctuation: /\|/ },
              },
              'table-line': {
                pattern: RegExp('^(' + a + ')' + r2 + '$'),
                lookbehind: true,
              ...
              'table-header-row': {
                pattern: RegExp('^' + a + '$'),
                inside: {
                  'table-header': { pattern: RegExp(t), alias: 'important', inside: o.languages.markdown },
                  punctuation: /\|/,
                },
              },
            },
        ...
        o.hooks.add('after-tokenize', function (e2) {
          ('markdown' !== e2.language && 'md' !== e2.language) ||
            !(function e3(n2) {
                ...
                for (var t2 = 0, a2 = n2.length; t2 < a2; t2++) {
                  ...
                  'code' !== s.type
                    ...
                    : ((r22 = s.content[1]),
                      ...
                      r22 &&
                        s &&
                        'code-language' === r22.type &&
                        'code-block' === s.type &&
                        'string' == typeof r22.content &&
                        ((r22 = r22.content.replace(/\b#/g, 'sharp').replace(/\b\+\+/g, 'pp')),
                        (r22 = 'language-' + (r22 = (/[a-z][\w-]*/i.exec(r22) || [''])[0].toLowerCase())),
                        s.alias
        ...
        o.hooks.add('wrap', function (e2) {
          if ('code-block' === e2.type) {
            for (var n2 = '', t2 = 0, a2 = e2.classes.length; t2 < a2; t2++) {
              var r22 = e2.classes[t2],
                r22 = /language-(.+)/.exec(r22);
              if (r22) {
                n2 = r22[1];
                break;
              }
            ...
            var s,
              i = o.languages[n2];
            i
              ? (e2.content = o.highlight(
                  (function (e3) {
                    e3 = e3.replace(l, '');
                    return (e3 = e3.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (e4, n3) {
                      var t3;
                      return '#' === (n3 = n3.toLowerCase())[0]
                        ? ((t3 = 'x' === n3[1] ? parseInt(n3.slice(2), 16) : Number(n3.slice(1))), c(t3))
                        : u[n3] || e4;
                    }));
                  })(e2.content),
                  i,
              ...
              : n2 &&
                'none' !== n2 &&
                o.plugins.autoloader &&
                ((s = 'md-' + /* @__PURE__ */ new Date().valueOf() + '-' + Math.floor(1e16 * Math.random())),
                (e2.attributes.id = s),
                o.plugins.autoloader.loadLanguages(n2, function () {
  ...
  Prism.hooks.add('after-tokenize', function (e) {
    if ('graphql' === e.language)
      for (
        var i = e.tokens.filter(function (e2) {
        ...
        if ('keyword' === n.type && 'mutation' === n.content) {
          ...
          if (
            ...
            '{' === c(0).content &&
            (o++, g(c(0), 'property-mutation'), 0 < t.length)
          ) {
            var s = d(/^\{$/, /^\}$/);
            if (-1 !== s)
              for (var l = o; l < s; l++) {
  ...
  (function (b) {
    ...
    function h(e2, n2, t2) {
      ...
      return (
        b.hooks.run('before-tokenize', e2),
        (e2.tokens = b.tokenize(e2.code, e2.grammar)),
        b.hooks.run('after-tokenize', e2),
        e2.tokens
      );
    }
    function l(a2, e2, r2) {
      var n2 = b.tokenize(a2, { interpolation: { pattern: RegExp(s), lookbehind: true } }),
        p = 0,
        d = {},
        n2 = h(
          n2
            .map(function (e3) {
              ...
              for (
                var n3, t2, e3 = e3.content;
                -1 !== a2.indexOf(((t2 = p++), (n3 = '___' + r2.toUpperCase() + '_' + t2 + '___')));
        ...
        (function e3(n3) {
          for (var t2 = 0; t2 < n3.length; t2++) {
            ...
            'string' == typeof c || 'string' == typeof c.content
              ? ((a3 = g[p]),
                -1 !== (u2 = (l2 = 'string' == typeof c ? c : c.content).indexOf(a3)) &&
                  (++p,
                  (r22 = l2.substring(0, u2)),
                  (o = d[a3]),
                  (s2 = void 0),
                  ((i = {})['interpolation-punctuation'] = f),
                  3 === (i = b.tokenize(o, i)).length &&
                    ((s2 = [1, 1]).push.apply(s2, h(i[1], b.languages.javascript, 'javascript')),
                    i.splice.apply(i, s2)),
                  (s2 = new b.Token('interpolation', i, m.alias, o)),
                  (i = l2.substring(u2 + a3.length)),
                  (o = []),
                  r22 && o.push(r22),
                  o.push(s2),
                  i && (e3((l2 = [i])), o.push.apply(o, l2)),
                  'string' == typeof c
                    ? (n3.splice.apply(n3, [t2, 1].concat(o)), (t2 += o.length - 1))
                    : (c.content = o)))
              : ((u2 = c.content), Array.isArray(u2) ? e3(u2) : e3([u2]));
          }
        })(n2),
        new b.Token(r2, n2, 'language-' + r2, a2)
      );
    }
        ...
        !(function e3(n2) {
          for (var t2 = 0, a2 = n2.length; t2 < a2; t2++) {
            ...
            'string' != typeof o &&
              ((r2 = o.content),
              Array.isArray(r2)
                ? 'template-string' === o.type
                  ? ((o = r2[1]),
                    3 === r2.length &&
                      'string' != typeof o &&
                      'embedded-code' === o.type &&
                      ((s2 = u(o)), (o = o.alias), (o = Array.isArray(o) ? o[0] : o), (i = b.languages[o])) &&
                      (r2[1] = l(s2, i, o)))
                  : e3(r2)
                : 'string' != typeof r2 && e3([r2]));
          }
        })(e2.tokens);
    });
  })(Prism),
      ...
      e.languages.insertBefore('jsdoc', 'keyword', {
        'optional-parameter': {
          ...
          inside: {
            ...
            code: { pattern: /(=)[\s\S]*(?=\]$)/, lookbehind: true, inside: n, alias: 'language-javascript' },
            punctuation: /[=[\]]/,
          },
        },
        'class-name': [
        ...
        example: {
          ...
          lookbehind: true,
          inside: {
            code: { pattern: /^([\t ]*(?:\*\s*)?)\S.*$/m, lookbehind: true, inside: n, alias: 'language-javascript' },
          },
        },
      }),
  ...
  (function (e) {
    ...
    e.languages.insertBefore('javascript', 'function-variable', {
      ...
      e.languages.insertBefore('javascript', 'punctuation', {
        'property-access': { pattern: n(/(\.\s*)#?<ID>/.source), lookbehind: true },
    ...
    for (
      var t = ['function', 'function-variable', 'method', 'method-variable', 'property-access'], a = 0;
      a < t.length;
      a++
    ) {
      var r2 = t[a],
        s = e.languages.javascript[r2],
        r2 = (s = 'RegExp' === e.util.type(s) ? (e.languages.javascript[r2] = { pattern: s }) : s).inside || {};
  ...
  (function (s) {
    ...
    (r2 = n(r2).source),
      ...
      (s.languages.jsx.tag.inside.comment = e.comment),
      s.languages.insertBefore(
        'inside',
        'attr-name',
        { spread: { pattern: n(/<SPREAD>/.source), inside: s.languages.jsx } },
        s.languages.jsx.tag,
      ),
      s.languages.insertBefore(
        'inside',
        'special-attr',
        {
          script: {
            ...
            inside: { 'script-punctuation': { pattern: /^=(?=\{)/, alias: 'punctuation' }, rest: s.languages.jsx },
          },
        },
        s.languages.jsx.tag,
      );
    function i(e2) {
      for (var n2 = [], t2 = 0; t2 < e2.length; t2++) {
        var a2 = e2[t2],
          r22 = false;
        'string' != typeof a2 &&
          ('tag' === a2.type && a2.content[0] && 'tag' === a2.content[0].type
            ? '</' === a2.content[0].content[0].content
              ? 0 < n2.length && n2[n2.length - 1].tagName === o(a2.content[0].content[1]) && n2.pop()
              : '/>' !== a2.content[a2.content.length - 1].content &&
                n2.push({ tagName: o(a2.content[0].content[1]), openedBraces: 0 })
            : 0 < n2.length && 'punctuation' === a2.type && '{' === a2.content
            ? n2[n2.length - 1].openedBraces++
            : 0 < n2.length && 0 < n2[n2.length - 1].openedBraces && 'punctuation' === a2.type && '}' === a2.content
            ? n2[n2.length - 1].openedBraces--
            : (r22 = true)),
          (r22 || 'string' == typeof a2) &&
            0 < n2.length &&
            0 === n2[n2.length - 1].openedBraces &&
            ((r22 = o(a2)),
            t2 < e2.length - 1 &&
              ('string' == typeof e2[t2 + 1] || 'plain-text' === e2[t2 + 1].type) &&
              ((r22 += o(e2[t2 + 1])), e2.splice(t2 + 1, 1)),
            0 < t2 &&
              ('string' == typeof e2[t2 - 1] || 'plain-text' === e2[t2 - 1].type) &&
              ((r22 = o(e2[t2 - 1]) + r22), e2.splice(t2 - 1, 1), t2--),
            (e2[t2] = new s.Token('plain-text', r22, null, r22))),
          a2.content && 'string' != typeof a2.content && i(a2.content);
      }
    }
    var o = function (e2) {
      return e2
        ? 'string' == typeof e2
          ? e2
          : 'string' == typeof e2.content
          ? e2.content
          : e2.content.map(o).join('')
        : '';
    };
      ...
      'string-literal': [
        {
          pattern: /"""(?:[^$]|\$(?:(?!\{)|\{[^{}]*\}))*?"""/,
          alias: 'multiline',
          inside: { interpolation: { pattern: /\$(?:[a-z_]\w*|\{[^{}]*\})/i, inside: n }, string: /[\s\S]+/ },
        },
        {
          pattern: /"(?:[^"\\\r\n$]|\\.|\$(?:(?!\{)|\{[^{}]*\}))*"/,
          alias: 'singleline',
  ...
  (function (e) {
    ...
    (n = n.replace(/<self>/g, function () {
      ...
      (e.languages.rust = {
        comment: [
          { pattern: RegExp(/(^|[^\\])/.source + n), lookbehind: true, greedy: true },
          { pattern: /(^|[^\\:])\/\/.*/, lookbehind: true, greedy: true },
        ],
...
var useThemeDictionary = (language, theme17) => {
  const [themeDictionary, setThemeDictionary] = (0, import_react2.useState)(themeToDict_default(theme17, language));
...
var useGetLineProps = (themeDictionary) =>
  (0, import_react3.useCallback)(
    (_a) => {
      var _b = _a,
        { className, style, line } = _b,
...
var Highlight = ({ children, language: _language, code, theme: theme17, prism }) => {
