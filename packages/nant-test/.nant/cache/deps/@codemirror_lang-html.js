import { javascript, javascriptLanguage, jsxLanguage, tsxLanguage, typescriptLanguage } from './chunk-YQB22COW.js';
import { css, cssLanguage } from './chunk-MIQUJKRB.js';
import {
  ContextTracker,
  EditorSelection,
  EditorView,
      ...
      if (tagName)
        for (let tag of other) {
          if (tag.tag == tagName && (!tag.attrs || tag.attrs(attrs2 || (attrs2 = getAttrs(n, input))))) {
            ...
            return {
              parser: tag.parser,
              overlay: [{ from: open.to, to: close.type.id == CloseTag ? close.from : n.to }],
            };
          }
        }
    }
...
var defaultNesting = [
  ...
  },
  {
    ...
    attrs(attrs) {
      return (
        (!attrs.lang || attrs.lang == 'css') && (!attrs.type || /^(text\/)?(x-)?(stylesheet|css)$/i.test(attrs.type))
      );
    },
...
var autoCloseTags = EditorView.inputHandler.of((view, from, to, text) => {
  ...
  let changes = state.changeByRange((range) => {
    ...
    if (text == '>' && around.name == 'OpenTag') {
      if (
        ((_b = (_a = around.parent) === null || _a === void 0 ? void 0 : _a.lastChild) === null || _b === void 0
          ? void 0
          : _b.name) != 'CloseTag' &&
        (name = elementName(state.doc, around.parent, head)) &&
        !selfClosers2.has(name)
      ) {
