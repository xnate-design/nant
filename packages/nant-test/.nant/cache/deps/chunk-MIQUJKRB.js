...
var parser = LRParser.deserialize({
  ...
  tokenizers: [
    ...
    3,
    4,
    new LocalTokenGroup('m~RRYZ[z{a~~g~aO#Z~~dP!P!Qg~lO#[~~', 28, 102),
  ],
  topRules: { StyleSheet: [0, 4], Styles: [1, 84] },
  specialized: [
    { term: 97, get: (value) => spec_callee[value] || -1 },
    { term: 56, get: (value) => spec_AtKeyword[value] || -1 },
    { term: 98, get: (value) => spec_identifier[value] || -1 },
  ],
  tokenPrec: 1169,
});

// ../../node_modules/.pnpm/@codemirror+lang-css@6.2.1_@codemirror+view@6.16.0/node_modules/@codemirror/lang-css/dist/index.js
...
export { defineCSSCompletionSource, cssCompletionSource, cssLanguage, css };
//# sourceMappingURL=chunk-MIQUJKRB.js.map
